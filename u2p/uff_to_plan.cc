...
int main(int argc, char *argv[])
{
  if (argc != 11)
  {
    ...
    cout << "Usage: <uff_filename> <plan_filename> <input_name> <output_name> <input channel>"
  ...
  parser->registerInput(inputName.c_str(), DimsCHW(inputChannel, inputHeight, inputWidth));
